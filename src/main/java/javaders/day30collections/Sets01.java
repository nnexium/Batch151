...
/*
1)Setler tekrarsız eleman(uniq) depolamak icin kullanilir.
2)3 tane Set Class vardir;
        i)HashSet Class:
        Hash benzersiz  id oluşturmatekniğidir.Bu tekniğe "Hashing Technique" denir.
        HashSet elemanlari rastgele sıralar.
        HashSet elemanlar siralamadığından çok hizli çalısır.
        HashSetler null i elemean olarak kabul eder.
        HashSet ler tekrarsiz eleman depolamak icindir.
        ii)LinkedHashSet Class:
                "LinkedHashSetler elemanlari sizin verdiginiz siraya göre dizdiklerinden(insertion order)
                HashSetlere göre yavaştırlar.
                "LinkedHashSetler" tekrarsiz eleman depolamak icindir.
        iii)TreeSet Class:
                "TreeSet"ler elemanlari natural order'a göre dizerler.
                "TreeSet"ler elemanlari natural ordera göre dizdiklerinden çooook yavaştırlar

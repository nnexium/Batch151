...
public class nestedIf01 {
     ...
     */
    /*
    1-if icinde if kullanırsanız "nested if" oluşturmuşsunuz demektir.
    2-nested if Javayı yavaşlatır bu yuzden, mecbur kalmadıkca kullanmayız.
    3-"nested if gibi Javayı yavaşlatan kodlar "Time Consuming" olarak adlandirilir.
     */

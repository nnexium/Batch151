...
public class C01_List {
    ...
    */
        ...
        for (int i = 0; i <list.size() ; i++) { // 0'dan listin uzunluguna kadar donguye aldık
            ...
            if(list.get(i)>10){ // listin i. indexindeki elemanı getirdik 10'dan buyuk mu kontrol ettik
                list.set(i,list.get(i)*2); // buyukse; i. indexindeki elemanı 2 katıyla set ettik
            }
